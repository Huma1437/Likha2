...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new MainScreenAdapter(this, albumList);
        ...
        try {
            Glide.with(this).load(R.drawable.p8).into((ImageView) findViewById(R.id.backdrop));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void prepareAlbums() {
        int[] covers = new int[]{
                R.drawable.discover_img,
                R.drawable.inspiration,
                R.drawable.startup_img,
                R.drawable.buy};

        Card card = new Card("Discover", covers[0]);
        albumList.add(card);

        card = new Card("Inspiration", covers[1]);
        albumList.add(card);

        card = new Card("Startup", covers[2]);
        albumList.add(card);

        card = new Card("Buy", covers[3]);
        albumList.add(card);
